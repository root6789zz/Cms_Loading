...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
           <strong> danh sách notify</strong>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                <tr>
                  <td>Không cung cấp mã OTP cho bất kỳ người nào để tránh bị lừa đảo   </td>
                  <td>true </td>
                  <td>15/11/2018 17:44:08  </td>
                  <td>1 </td>
...
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder="Không cung cấp mã OTP cho bất kỳ người nào để tránh bị lừa đảo  ">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Trạng thái</label>
...
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Cổng</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder="1">
</div>
</div>
</form>
      </div>
