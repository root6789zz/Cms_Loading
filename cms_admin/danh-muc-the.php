...
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Serial thẻ</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Serial thẻ">
</div>
</div>
