...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong> Phát lộc cho người chơi</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="box-body">
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Nickname gửi </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Nickname gửi ">
</div>
</div>
<div class="form-group">
