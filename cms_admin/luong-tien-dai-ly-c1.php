...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <small>  Luồng tiền đại lý cấp 1</small>
          </h1>
          <ol class="breadcrumb">
...
<div class="col-sm-8">
<input type="text" class="form-control pull-right" id="reservation"  placeholder="Click chọn thời gian">
...
<br/>
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Luồng tiền cấp 1</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                <tr>
                  <th>Tổng mua đại lý</th>
                  <th>Tổng bán đại lý</th>
                  <th>Chênh lệch mua bán đại lý</th>
                  <th>Tổng mua người chơi
</th>
                  <th>Tổng bán người chơi</th>
                  <th>Chênh lệch mua bán người chơi</th>
