...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
                <strong>Chuyển khoản cho admin</strong>
                  </h1>
          <ol class="breadcrumb">
...
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Nickname nhận">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Số tiền nhận *  </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Số tiền nhận">
</div>
</div>
<div class="form-group">
