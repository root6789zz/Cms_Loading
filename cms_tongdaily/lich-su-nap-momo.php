...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Lịch sử nạp momo</strong>
          </h1>
          <ol class="breadcrumb">
...
<option>--Chọn partner--</option>
<option>HAPPY</option>
<option>SHOP THE NHANH</option>
</select></div>
</div>
<div class="form-group">
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">RefKey</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder="RefKey">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">RefSendID</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder="RefSendID">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">NickName</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder="NickName">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label"> Tài khoản momo nhận </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder=" Tài khoản momo nhận  ">
</div>
</div>
                                    <div class="form-group">
