...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Tài khoản thường phát lộc</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="box-body">
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Tên đăng nhập gửi  </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Tên đăng nhập gửi  ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Mật khẩu gửi   </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Mật khẩu gửi ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Nickname nhận </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Nickname nhận  ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Danh sách Nickname nhận </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Danh sách Nickname nhận  ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Số tiền nhận  </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Số tiền nhận ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Số tiền thực chuyển  </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Số tiền thực chuyển  ">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Nội dung   </label>
<div class="col-sm-8">
<input type="text" class="form-control pull-right"placeholder="Nội dung  ">
</div>
</div>
</div>

<div class="box-footer">
<button type="submit" class="btn btn-info pull-right">Chuyển</button>
</div>
