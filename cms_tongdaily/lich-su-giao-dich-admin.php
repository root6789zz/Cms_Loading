...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Lịch sử giao dịch Admin</strong>
          </h1>
          <ol class="breadcrumb">
...
<br/>
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Tra cứu lịch sử giao dịch</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>200</td>
                  <td>0</td>
                  <td>21/03/2022 13:31:43</td>
                  <td>Hoàn thành nhiệm vụ Điểm danh hàng ngày</td>
                  <td><small class="label pull-right bg-red">Thất bại</small></td>
                </tr>
                <tr>
                  <td>bohuan01</td>
                  <td>Người dùng</td>
                  ...
                  <td>21/03/2022 13:31:43</td>
                  <td>Hoàn thành nhiệm vụ Điểm danh hàng ngày</td>
                  <td><small class="label pull-right bg-green">thành công</small></td>
                </tr>
                <tr>
                  <td>bohuan01</td>
                  <td>Người dùng</td>
                ...
                <tr>
                  ...
                  <td>20.000.000</td>
                  <td>21/03/2022 13:31:43</td>
                  <td>Admin chuyển 20.000.000 cho user KiaSeltos</td>
                  <td><small class="label pull-right bg-green">thành công</small></td>
                </tr>
                </tbody>
                </tfoot>
