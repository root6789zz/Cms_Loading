...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong> Danh Sách Mail Người Dùng</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="box-body">
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label"> Người nhận  </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Người nhận">
</div>
</div>
                                    <div class="form-group">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td>lgbg11</td>
                  <td>Cộng Tiền </td>
                  <td>Chúc mừng bạn nhận được 50.000.000 từ Admin với nội dung: s</td>
                  <td>3/16/2022 3:54:04 PM  </td>
