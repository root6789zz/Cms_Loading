...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Kiểm tra lịch sử game</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="box-body">
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">  Phiên  </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder=" Phiên">
</div>
</div>
<div class="form-group">
...
<option value="3">Thần Tài</option>
<option value="4">Night Club</option>
<option value="7">Xèng 777</option>
<option value="8">Tài xỉu</option>
<option value="10">Vòng quay may mắn</option>
<option value="11">Mini Pocker</option>
<option value="12">Gem</option>
<option value="14">Rồng Hổ</option>
<option value="15">Odins</option>
<option value="16">Bến Thượng Hải</option>
<option value="17">Gái Nhảy</option>
<option value="18">Racing Wild</option>
<option value="19">Baccarat</option>
<option value="20">Bầu Cua</option>
<option value="21">Lô Đề</option>
<option value="23">Bắn Cá</option>
<option value="51">Ba Cây</option>
<option value="54">TIEN_LEN_MN</option>
<option value="55">MAU_BINH</option>
<option value="57">Poker Texas Holdeim</option>
<option value="61">BA_CAY_GA</option>
<option value="62">BA_CAY_BIEN</option>
<option value="63">Xóc Đĩa</option>
<option value="66">TIEN_LEN_MN_SOLO</option>
</select>
</div>
</div>
                                    <div class="form-group">
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label"> Sắp xếp theo   </label>
<div class="col-sm-8">
