...
<br/>
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> Kiểm Kê Viettel</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> Kiểm Kê Vinaphone</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> Kiểm Kê Mobiphone</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"> Tổng Thống kê</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
