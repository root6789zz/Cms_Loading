...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Cập nhật kết quả xổ số</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">Giải đặc biệt  </label>
<div class="col-sm-8">
<div class="row">
  <div class="col-4"><input type="text" id="inputMaVeSo" placeholder="Mã Request">
</div>
  <div class="col-4"><input type="text" id="inputMaVeSo" placeholder="Mã Request">
</div>
  <div class="col-4"><input type="text" id="inputMaVeSo" placeholder="Mã Request">
