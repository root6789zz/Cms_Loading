...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
                <strong>Thu hồi giao dịch user vs user</strong>
          </h1>
          <ol class="breadcrumb">
...
<h3 class="box-title">Thu hồi giao dịch user vs user</h3>
</div>
                            ...
                            <form class="form-horizontal">
                                <div class="box-body">
                    <div class="form-group">
                         <label for="inputPassword3" class="col-sm-4 control-label"> Nick Name </label>
                         <div class="col-sm-8">
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-sm-8">
                      <input type="text" class="form-control" placeholder="Đối tác ">
                    </div>
                    </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Ngày tháng</th>
                  <th>Người tạo</th>
                  <th>Số dư người tạo</th>
                  <th>Người nhận</th>
                  <th>Số dư người nhận</th>
                  <th>Mô tả</th>
                </tr>
                </thead>
                <tbody>
