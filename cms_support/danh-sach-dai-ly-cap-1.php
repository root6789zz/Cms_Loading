...
<div class="box box-info">
<div class="box-header with-border">
<h3 class="box-title">Thu hồi ví gift code đại lý</h3>
</div>
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Tổng số Q trong ví</label>
<div class="col-sm-8">
999
</div>
</div>
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Tổng số GiftCode</label>
<div class="col-sm-8">
999</div>
</div>
</div>
...
<div class="box-footer">
<button type="submit" class="btn btn-info pull-right">Thu hồi</button>
</div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>B trong ví</th>
                  <th>B GiftCode</th>
                  <th>Số điện thoại hiển thị</th>
                  <th>Đại lý cấp</th>
                  <th>Tên đại lý cha</th>
