...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Kiểm tra lịch sử giao dịch</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label"> Chọn loại giao dịch </label>
<div class="col-sm-8">
<select class="form-control">
<option>--Chọn loại giao dịch--</option>
<option>Giftcode</option>
<option>Nạp thẻ</option>
<option>VIP</option>
<option>Đổi thẻ</option>
<option>Nạp bank</option>
<option>Rút bank</option>
<option>Két</option>

</select></div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label"> Loại đối tượng  </label>
<div class="col-sm-8">
<select class="form-control">
