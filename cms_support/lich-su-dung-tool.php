    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
            Rol
            <strong>Lịch sử dùng tool</strong>
          </h1>
                <ol class="breadcrumb">
                            ...
                            <form class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="inputMaVeSo" placeholder="Tên tài khoản">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Chức năng</label>
                                        <div class="col-sm-8">
                                            <select class="form-control">
                                                <option>Tool tài xỉu</option>
                                                <option>Tool slot</option>
                                            </select>
                                        </div>
                                    </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control pull-right active" id="reservation" placeholder="Thời gian">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-info pull-right">kiểm tra</button>
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Lịch sử dùng tool</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>superadmin</td>
                                            <td>Đã kích nổ hũ cho Nick name : ABC</td>
                                            <td>Corona</td>
                                            <td>100</td>
                                            <td>06/03/2022 09:27:56</td>
                                            <td>192.168.1.1</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>superadmin</td>
                                            <td>Đã kích nổ hũ cho Nick name : XYZ</td>
                                            <td>Đế chế</td>
                                            <td>100</td>
                                            <td>06/03/2022 09:27:56</td>
                                            <td>192.168.1.1</td>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td>superadmin</td>
                                            <td>Kích nổ hũ cho nick name : Caigithe</td>
                                            <td>Odin</td>
                                            <td>-</td>
                                            <td>06/03/2022 09:27:56</td>
                                            <td>192.168.1.1</td>
