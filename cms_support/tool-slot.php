                    ...
                    <div class="col-md-6">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Set nổ hũ</h3>
                            </div>
                            ...
                            <form class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="inputMaVeSo" placeholder="Nick name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control">
                                                ...
                                                <option>Mini Poker</option>
                                                <option>Gem</option>
                                                <option>Mini 777</option>
