        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Set tài xỉu</h3>
                            </div>
                            ...
                            <form class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group text-center">
                                        <button class="btn btn-danger">Set Tài</button>
                                        <button class="btn btn-success">Set Xỉu</button>
                                        <button class="btn btn-warning">Mặc định</button>
                                        <button class="btn btn-primary">Random</button>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Phiên</label>
                                        <div class="col-sm-8">
                                            226108
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Đếm ngược</label>
                                        <div class="col-sm-8">
                                            18 s
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Kết quả xúc xắc</label>
                                        <div class="col-sm-8">
                                            6-6-6
                    ...
                    <div class="col-md-6">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Thống kê tài xỉu hôm nay</h3>
                            </div>
                            ...
                            <form class="form-horizontal">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Ngày</label>
                                        <div class="col-sm-8">
                                            3/20/2022 12:00:54 AM   
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Tổng thu </label>
                                        <div class="col-sm-8">
                                            Tổng thu    
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Tổng chi</label>
                                        <div class="col-sm-8">
                                            1,112,546,707,750</div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Tổng phế</label>
                                        <div class="col-sm-8">
                                            10,651,793,953</div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Lãi</label>
                                        <div class="col-sm-8">
                                            15,137,555,926</div>
                                    </div>
                                </div>
          ...
          <div class="box">
            <div class="box-header">
              <span class="badge bg-red"><strong>Thông tin cửa Tài</strong></span>

              <div class="box-tools">
<strong>Số người đặt: 100</strong> |<strong>Tổng tiền cược : 500.000.000</strong>
              </div>
            </div>
            <!-- /.box-header -->
          ...
          <div class="box">
            <div class="box-header">
              <span class="badge bg-green"><strong>Thông tin cửa Xỉu</strong></span>
