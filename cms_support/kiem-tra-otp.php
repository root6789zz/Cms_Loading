...
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder=" Số điện thoại">
</div>
</div>
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label"> Tên hiển thị    </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Tên hiển thị   ">
</div>
</div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <th>Oty Type</th>
                  <th>Ngày tạo</th>
                  <th>Trạng thái Otp</th>
                  <th>Trạng thái gửi SMS</th>
                </tr>
