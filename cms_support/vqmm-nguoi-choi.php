...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong> Báo cáo vòng quay nhỏ</strong>
          </h1>
          <ol class="breadcrumb">
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Hạng</label>
<div class="col-sm-8">
<select class="form-control">
<option>Người chơi mới</option>
<option>Đá</option>
<option>Đồng & Bạc</option>
<option>Vàng & Kim cương</option>
</select></div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Giải thưởng:</label>
<div class="col-sm-8">
<select class="form-control">
<option value="1">Tất cả</option>
<option value="1">200.000 Bom</option>
<option value="2">100.000 Bom</option>
<option value="3">50.000 Bom</option>
<option value="4">20.000 Bom</option>
<option value="5">10.000 Bom</option>
<option value="6">5.000 Bom</option>
<option value="7">2.000 Bom</option>
<option value="8">1.000 Bom</option>
<option value="9">500 Bom</option>
<option value="10">200 Bom</option>
<option value="11">100 Bom</option>
<option value="12">Trượt</option>
<option value="1">200.000 Bom</option>
<option value="2">100.000 Bom</option>
<option value="3">50.000 Bom</option>
<option value="4">20.000 Bom</option>
...
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Giải FreeSpin: </label>
<div class="col-sm-8">
<select class="form-control">
<option value="1">Tất cả</option>
<option value="1">10 lượt quay MiniXPoker</option>
<option value="2">1 lượt quay Candy</option>
<option value="3">1 lượt quay Tam Quốc</option>
<option value="4">1 lượt quay Tam Quốc</option>
<option value="5">1 lượt quay Si&#234;u Xe</option>
<option value="6">Trượt</option>
<option value="1">10 lượt quay MiniXPoker</option>
<option value="2">1 lượt quay Candy</option>
<option value="3">1 lượt quay Tam Quốc</option>
<option value="4">1 lượt quay Tam Quốc</option>
<option value="5">1 lượt quay Si&#234;u Xe</option>
<option value="6">Trượt</option>
<option value="7">1 lượt quay BumBum</option>
<option value="7">1 lượt quay BumBum</option>
<option value="1">10 lượt quay MiniXPoker</option>
<option value="2">1 lượt quay Candy</option>
<option value="3">1 lượt quay Tam Quốc</option>
