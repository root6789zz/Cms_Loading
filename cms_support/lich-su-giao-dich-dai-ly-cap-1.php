...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <small>  Tra Cứu Giao Dịch Đại Lý</small>
          </h1>
          <ol class="breadcrumb">
...
<div class="box-body">
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">NickName đại lý</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="Nhập tên đại lý">
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label">Loại đối tác</label>
<div class="col-sm-8">
...
<div class="form-group">
<label for="inputEmail3" class="col-sm-4 control-label">NickName đối tác</label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputMaVeSo" placeholder="NickName đối tác">
</div>
</div>
<div class="form-group">
...
<br/>
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">Tra cứu lịch sử giao dịch cấp 1</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
