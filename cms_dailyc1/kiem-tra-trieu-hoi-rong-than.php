...
<?php include 'sidebar.php';?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Rol
            <strong>Kiểm tra triệu hồi rồng thần</strong>
          </h1>
          <ol class="breadcrumb">
...
<option value="2">TIEN_LEN_MN</option>
<option value="3">MAU_BINH</option>
<option value="4">POKER_TEXAS</option>
<option value="7">BA_CAY_GA</option>
<option value="8">BA_CAY_BIEN</option>
<option value="10">Xóc Đĩa</option>
<option value="11">TIEN_LEN_MN_SOLO</option>
</select>
</div>
</div>
<div class="form-group">
...
<div class="col-sm-8">
<select id="gameId" name="gameId" class="form-control">
<option value="1">Theo tên hiển thị</option>
</select>
</div>
</div>
</div>
<div class="form-group">
<label for="inputPassword3" class="col-sm-4 control-label"> Giá trị tìm kiếm *  </label>
<div class="col-sm-8">
<input type="text" class="form-control" id="inputID" placeholder=" Giá trị tìm kiếm * ">
</div>
</div>
                                    <div class="form-group">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>0 </td>
                  <td>165.915.492</td>
                  <td>17/03/2022 12:22:10</td>
                  <td>Trao thưởng Triệu Hồi Rồng Tài xỉu cho Summit 2.716.345 Bom vào tài khoản chính</td>
