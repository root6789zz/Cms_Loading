...
<h3 class="box-title">Check lịch sử</h3>
</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control">
                                                <option>Nhận tiền thưởng</option>
                                                <option>Nhận tiền từ Tổng đại lý</option>
                                                <option>Chuyển khoản cho Tổng đại lý</option>
                                                <option>Nhận tiền từ user</option>
                                                <option>Chuyển khoản cho user</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td>50000</td>
                  <td>Chuyển tiền cho tổng đại lý</td>
                  <td>25/02/2022 01:02:02</td>
